...
require'nvim-treesitter.configs'.setup {
	ensure_installed = {"c_sharp", "glsl", "c", "vue", "python", "typescript", "vim", "yaml", "rust", "lua", "commonlisp", "zig"}, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
	sync_install = true,
	highlight = {
